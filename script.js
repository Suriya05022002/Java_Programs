...
public class MaxOccurringCharacter {
  ...
  function displayProgram(index) {
    ...
    const html = `
      ...
      <div class="code-block">
        ...
        <code id="code-${program.id}">${escapeHtml(program.code)}</code>
      </div>
  ...
  function updateProgramList() {
    ...
    filteredPrograms.forEach((program, index) => {
      ...
      const shortTitle = program.title.length > 25 
  ...
  function filterPrograms() {
    ...
    filteredPrograms = selectedCategories.length === 0
      ? [...programs]
